...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column bg-gradient-light">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-dark">Peminjaman Barang</h1>
    ...
    <div class="form-group">
        <label for="jumlah" class="text-dark">Jumlah dipinjam</label>
        <input type="number" class="form-control form-control-user" placeholder="Jumlah" name="jumlah">
    </div>
    <div class="form-group">
        <label for="keperluan" class="text-dark">Keperluan</label>
